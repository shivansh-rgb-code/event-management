...
A REST API for managing society events. This project was built as part of the GDG Backend Task 1 to practice CRUD operations, validation, database integration, API features, and business logic.
